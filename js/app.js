...
function showSummaryPopup(comunaNombre, summaryData) {
  ...
  html += '<h3 style="margin: 0 0 15px 0; color: #ffffff; font-size: 18px; font-weight: 600; border-bottom: 2px solid #3b82f6; padding-bottom: 10px; position: sticky; top: 0; background: #1e293b; z-index: 1;">📍 ' + comunaNombre + '</h3>';
